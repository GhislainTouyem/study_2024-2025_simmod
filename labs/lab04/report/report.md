...
# Код для построение графика изменении размера окна TCP в Xgraph 
...
![Схема моделируемой сети при N=20](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/10.jpg){#fig:001 width=70%}



# Резултати после запуска


![Изменение размера окна TCP на линке 1-го источника при N=20](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/5.jpg){#fig:002 width=70%}


![Изменение размера окна TCP на всех источниках при N=20](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/6.jpg){#fig:003 width=70%}


![Изменение размера длины очереди на линке (R1–R2) при N=20, qmin = 75, qmax = 150](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/7.jpg){#fig:004 width=70%}


![Изменение размера средней длины очереди на линке (R1–R2) при N=20, qmin = 75, qmax = 150](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/8.jpg){#fig:005 width=70%}

# Код для построение графика изменении размера окна TCP в GNUPlot
...
![Резултати после запуска в GNUPlot](/home/ghislain/work/study/2024-2025/Имитационное моделирование/simmod/labs/lab04/report/image/11.jpg){#fig:006 width=70%}
